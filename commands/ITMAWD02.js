        ...
        switch (today) {
          ...
          case 2:
            ...
            const Embed1 = new Discord1.MessageEmbed();
               Embed1.setDescription("You have no Classes for tomorrow");
